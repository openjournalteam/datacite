...
<div class="listPanel__footer">
    <div style="display: flex;align-items: center;">
        ...
        <button 
            ...
            {if $canClickPrevious} 
                hx-get="{url page="management" op="importexport" path=['plugin', $plugin, 'queuetab'] params=['page' => $previousPage, 'querySearch' => $querySearch]}" 
        ...
        <div style="display: flex;align-items: center; gap: 4px;">
            <button 
                ...
                {if $canClickNext} 
                    hx-get="{url page="management" op="importexport" path=['plugin', $plugin, 'queuetab'] params=['page' => $nextPage, 'querySearch' => $querySearch]}"
                    hx-target="#queue-tab-content"
                    hx-disabled-elt="this" 
